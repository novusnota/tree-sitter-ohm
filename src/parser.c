...
enum {
  ...
  sym__base = 45,
  sym_params = 46,
  sym_terminal_string = 47,
  sym_one_char_terminal = 48,
  sym__terminal_char = 49,
  aux_sym_source_file_repeat1 = 50,
  aux_sym_grammar_body_repeat1 = 51,
  aux_sym_formals_repeat1 = 52,
  aux_sym_rule_body_repeat1 = 53,
  aux_sym_override_rule_body_repeat1 = 54,
  aux_sym_seq_repeat1 = 55,
  aux_sym__base_repeat1 = 56,
  aux_sym_params_repeat1 = 57,
  aux_sym_terminal_string_repeat1 = 58,
  alias_sym_param = 59,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [aux_sym__base_repeat1] = "_base_repeat1",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [aux_sym__base_repeat1] = aux_sym__base_repeat1,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [9] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_rule, 3, .production_id = 9), SHIFT(9),
  [12] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule, 3, .production_id = 9),
  [14] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [16] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [18] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [20] = {.entry = {.count = 1, .reusable = true}}, SHIFT(103),
  [22] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [24] = {.entry = {.count = 1, .reusable = true}}, SHIFT(39),
  [26] = {.entry = {.count = 1, .reusable = true}}, SHIFT(42),
  [28] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_rule, 2, .production_id = 4), SHIFT(9),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule, 2, .production_id = 4),
  [33] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [35] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_rule, 3, .production_id = 10), SHIFT(9),
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule, 3, .production_id = 10),
  [40] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_rule, 4, .production_id = 16), SHIFT(9),
  [43] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule, 4, .production_id = 16),
  [45] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_seq_repeat1, 2), SHIFT_REPEAT(9),
  ...
  [59] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_seq_repeat1, 2), SHIFT_REPEAT(42),
  [62] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__base, 1),
  [64] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [66] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_one_char_terminal, 3),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__base, 3),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_seq, 1),
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__base, 4),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__base, 2),
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_term, 2, .production_id = 12),
  [80] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [82] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_params, 3, .production_id = 23),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_terminal_string, 2),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_term, 1, .production_id = 8),
  [88] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_params, 2),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_term, 2, .production_id = 11),
  [94] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_terminal_string, 3),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_params, 4, .production_id = 23),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_term, 3, .production_id = 18),
  [102] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [104] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_seq, 1), SHIFT(9),
  [107] = {.entry = {.count = 1, .reusable = true}}, SHIFT(23),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_term, 3, .production_id = 19),
  ...
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_term, 3, .production_id = 20),
  ...
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_terminal_string_repeat1, 2),
  [129] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_terminal_string_repeat1, 2), SHIFT_REPEAT(41),
  ...
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_top_level_term, 1, .production_id = 7),
  [142] = {.entry = {.count = 1, .reusable = true}}, SHIFT(25),
  [144] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_override_top_level_term, 1, .production_id = 7),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_formals, 2),
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_override_rule_body, 3),
  [152] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [154] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_rule_body_repeat1, 2),
  [156] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_rule_body_repeat1, 2), SHIFT_REPEAT(17),
  [159] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_override_rule_body, 2),
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2),
  [163] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(57),
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_body, 2),
  [168] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_override_rule_body_repeat1, 2),
  [174] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_override_rule_body_repeat1, 2), SHIFT_REPEAT(10),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_body, 3),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_override_rule_body, 1),
  [181] = {.entry = {.count = 1, .reusable = true}}, SHIFT(104),
  [183] = {.entry = {.count = 1, .reusable = true}}, SHIFT(59),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_formals, 4),
  [187] = {.entry = {.count = 1, .reusable = true}}, SHIFT(37),
  [189] = {.entry = {.count = 1, .reusable = true}}, SHIFT(89),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_body, 1),
  [193] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_grammar_body_repeat1, 2), SHIFT_REPEAT(37),
  [196] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_grammar_body_repeat1, 2),
  [198] = {.entry = {.count = 1, .reusable = true}}, SHIFT(84),
  [200] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_formals, 3),
  [202] = {.entry = {.count = 1, .reusable = true}}, SHIFT(14),
  [204] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [206] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_params_repeat1, 2), SHIFT_REPEAT(33),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_params_repeat1, 2),
  [211] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [213] = {.entry = {.count = 1, .reusable = true}}, SHIFT(26),
  [215] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_top_level_term, 1, .production_id = 6),
  [217] = {.entry = {.count = 1, .reusable = true}}, SHIFT(105),
  [219] = {.entry = {.count = 1, .reusable = true}}, SHIFT(58),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__base_repeat1, 2),
  [223] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__base_repeat1, 2), SHIFT_REPEAT(35),
  [226] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_formals_repeat1, 2), SHIFT_REPEAT(105),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_formals_repeat1, 2),
  [231] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_override_top_level_term, 1, .production_id = 6),
  [233] = {.entry = {.count = 1, .reusable = true}}, SHIFT(64),
  [235] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_top_level_term, 2, .production_id = 13),
  [237] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [239] = {.entry = {.count = 1, .reusable = true}}, SHIFT(106),
  [241] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_case_name, 3),
  [243] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_override_top_level_term, 2, .production_id = 13),
  [245] = {.entry = {.count = 1, .reusable = true}}, SHIFT(20),
  [247] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_terminal_string_repeat1, 1), SHIFT(11),
  [250] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_terminal_string_repeat1, 1),
  [252] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grammar_body, 3),
  [254] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grammar, 3, .production_id = 3),
  [256] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule, 4, .production_id = 15),
  [258] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grammar_body, 2),
  ...
  [266] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule, 3, .production_id = 5),
  [268] = {.entry = {.count = 1, .reusable = true}}, SHIFT(79),
  [270] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule, 4, .production_id = 17),
  [272] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule, 5, .production_id = 21),
  [274] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grammar, 2, .production_id = 1),
  ...
  [284] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rule_descr, 3),
  ...
  [300] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_super_grammar, 2, .production_id = 2),
